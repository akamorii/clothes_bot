...
async def make_order_three(message: types.Message, state: FSMContext):
    ...
    await message.answer("Введите адрес пункта Почты России 🚛 Например: Московская область, улица Пушкина, дом 37\n\nЕсли Вы не уверены в правильности написания адреса пункта выдачи, после оплаты заказа напишите нам @Business228777 и скиньте номер своего заказа и адрес пункта выдачи. Мы все проверим и отправим именно туда, куда Вам надо🤝Если Вы написали неправильный адрес пункта выдачи и не написали нам, то мы не сможем с Вами никак связаться и Ваши деньги будут потеряны! Пожалуйста, будьте внимательны🆘", reply_markup=main_menu.as_markup())
